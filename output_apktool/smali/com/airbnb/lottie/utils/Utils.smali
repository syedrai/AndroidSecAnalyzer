...
.method public static applyTrimPathIfNeeded(Landroid/graphics/Path;FFF)V
    ...
    .line 144
    .local v3, "tempPath2":Landroid/graphics/Path;
    const/4 v4, 0x0
    ...
    .line 166
    invoke-static {v8, v4}, Lcom/airbnb/lottie/utils/MiscUtils;->floorMod(FF)I
    ...
    .line 167
    invoke-static {v9, v4}, Lcom/airbnb/lottie/utils/MiscUtils;->floorMod(FF)I
    ...
    invoke-virtual {v1, v8, v9, v2, v11}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z
    ...
    invoke-virtual {v1, v5, v12, v3, v11}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z
    ...
    invoke-virtual {v1, v5, v4, v3, v11}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z
    ...
    .end local v7    # "end":F
    .end local v8    # "newStart":F
    .end local v9    # "newEnd":F
