...
.method public modifyShape(Lcom/airbnb/lottie/model/content/ShapeData;)Lcom/airbnb/lottie/model/content/ShapeData;
    ...
    .local v21, "i":I
    .local v22, "startingCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    ...
    .local v23, "previousCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    .local v24, "previousPreviousCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    ...
    .local v10, "dxToPreviousVertex":F
    ...
    .local v27, "previousVertexPercent":F
    ...
    .line 133
    .local v1, "newVertex2X":F
    move/from16 v28, v2

    .end local v2    # "dxToNextVertex":F
    ...
    .line 136
    .local v2, "newVertex2Y":F
    move/from16 v29, v6

    .end local v6    # "dyToNextVertex":F
    .local v29, "dyToNextVertex":F
    iget v6, v11, Landroid/graphics/PointF;->x:F

    sub-float v6, v9, v6

    const v30, 0x3f0d4952    # 0.5519f
    ...
    .end local v7    # "dToPreviousVertex":F
    .local v31, "dToPreviousVertex":F
    ...
    .end local v8    # "nextVertexPercent":F
    .local v32, "nextVertexPercent":F
    ...
    .end local v10    # "dxToPreviousVertex":F
    .local v33, "dxToPreviousVertex":F
    ...
    .local v30, "vertex":Landroid/graphics/PointF;
    add-int/lit8 v11, v5, -0x1

    move-object/from16 v34, v12

    .end local v12    # "inPoint":Landroid/graphics/PointF;
    .local v34, "inPoint":Landroid/graphics/PointF;
    ...
    invoke-virtual {v11, v9, v0}, Lcom/airbnb/lottie/model/CubicCurveData;->setControlPoint2(FF)V

    .line 146
    invoke-virtual {v11, v9, v0}, Lcom/airbnb/lottie/model/CubicCurveData;->setVertex(FF)V
    ...
    .line 150
    :cond_6
    invoke-virtual {v12, v6, v7}, Lcom/airbnb/lottie/model/CubicCurveData;->setControlPoint1(FF)V
    ...
    .line 156
    invoke-virtual {v11, v1, v2}, Lcom/airbnb/lottie/model/CubicCurveData;->setVertex(FF)V

    .line 157
    invoke-virtual {v12, v1, v2}, Lcom/airbnb/lottie/model/CubicCurveData;->setControlPoint1(FF)V

    .line 158
    nop

    .end local v0    # "newVertex1Y":F
    .end local v1    # "newVertex2X":F
    .end local v2    # "newVertex2Y":F
    .end local v6    # "newVertex1OutPointX":F
    .end local v7    # "newVertex1OutPointY":F
    .end local v8    # "newVertex2InPointX":F
    .end local v9    # "newVertex1X":F
    ...
    .end local v27    # "previousVertexPercent":F
    .end local v28    # "dxToNextVertex":F
    .end local v29    # "dyToNextVertex":F
    .end local v31    # "dToPreviousVertex":F
    .end local v32    # "nextVertexPercent":F
    .end local v33    # "dxToPreviousVertex":F
    add-int/lit8 v5, v5, 0x1
    ...
    .end local v19    # "roundedness":F
    .end local v20    # "isClosed":Z
    .end local v21    # "i":I
    .end local v22    # "startingCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    .end local v23    # "previousCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    .end local v24    # "previousPreviousCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    .end local v30    # "vertex":Landroid/graphics/PointF;
    .end local v34    # "inPoint":Landroid/graphics/PointF;
    .local v0, "isEndOfCurve":Z
    .local v2, "roundedness":F
    .local v6, "isClosed":Z
    .local v7, "i":I
    ...
    .restart local v19    # "roundedness":F
    .restart local v20    # "isClosed":Z
    .restart local v21    # "i":I
    .restart local v22    # "startingCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    .restart local v23    # "previousCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    .restart local v24    # "previousPreviousCurve":Lcom/airbnb/lottie/model/CubicCurveData;
    .restart local v30    # "vertex":Landroid/graphics/PointF;
    .restart local v34    # "inPoint":Landroid/graphics/PointF;
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/airbnb/lottie/model/CubicCurveData;->getControlPoint2()Landroid/graphics/PointF;
    ...
    .line 165
    invoke-virtual/range {v23 .. v23}, Lcom/airbnb/lottie/model/CubicCurveData;->getVertex()Landroid/graphics/PointF;
    ...
    .line 166
    invoke-virtual/range {v22 .. v22}, Lcom/airbnb/lottie/model/CubicCurveData;->getControlPoint1()Landroid/graphics/PointF;
