...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/ActionBarContextView;->setBackground(Landroid/graphics/drawable/Drawable;)V
...
.method public initForMode(Landroid/support/v7/view/ActionMode;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->mCloseButton:Landroid/view/View;

    .line 172
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->mCloseButton:Landroid/view/View;
    ...
    invoke-virtual {v2, p0}, Landroid/support/v7/widget/ActionMenuPresenter;->getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/MenuView;

    move-result-object v2

    check-cast v2, Landroid/support/v7/widget/ActionMenuView;

    iput-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->mMenuView:Landroid/support/v7/widget/ActionMenuView;
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/ActionMenuView;->setBackground(Landroid/graphics/drawable/Drawable;)V

    .line 191
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->mMenuView:Landroid/support/v7/widget/ActionMenuView;

    invoke-virtual {p0, v2, v1}, Landroid/support/v7/widget/ActionBarContextView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public killMode()V
    ...
    .line 206
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->mCloseButton:Landroid/view/View;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {v1, v8, v5}, Landroid/support/v7/widget/ActionBarContextView;->next(IIZ)I
    ...
    .line 340
    invoke-static {v2, v9, v5}, Landroid/support/v7/widget/ActionBarContextView;->next(IIZ)I
...
.method public bridge synthetic setupAnimatorToVisibility(IJ)Landroidx/core/view/ViewPropertyAnimatorCompat;
    ...
    .line 41
    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/widget/AbsActionBarView;->setupAnimatorToVisibility(IJ)Landroidx/core/view/ViewPropertyAnimatorCompat;
