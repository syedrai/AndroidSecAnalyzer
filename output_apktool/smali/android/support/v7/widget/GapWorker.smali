...
.method private buildTaskList()V
    ...
    :goto_4
    iput-boolean v11, v9, Landroid/support/v7/widget/GapWorker$Task;->neededNextFrame:Z
...
.method private flushTaskWithDeadline(Landroid/support/v7/widget/GapWorker$Task;J)V
    ...
    .line 354
    iget-boolean v0, p1, Landroid/support/v7/widget/GapWorker$Task;->neededNextFrame:Z
...
.method private prefetchPositionWithDeadline(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 295
    invoke-virtual {v0, p2, v3, p3, p4}, Landroid/support/v7/widget/RecyclerView$Recycler;->tryGetViewHolderForPositionByDeadline(IZJ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/RecyclerView$Recycler;->recycleView(Landroid/view/View;)V

    goto :goto_0

    .line 308
    :cond_2
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/RecyclerView$Recycler;->addViewHolderToRecycledViewPool(Landroid/support/v7/widget/RecyclerView$ViewHolder;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
