...
.method private swapMoveOp(Ljava/util/List;II)V
    ...
    .line 40
    .local v4, "moveOp":Landroid/support/v7/widget/AdapterHelper$UpdateOp;
    ...
    .line 41
    .local v6, "nextOp":Landroid/support/v7/widget/AdapterHelper$UpdateOp;
    ...
    .end local p1    # "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v7/widget/AdapterHelper$UpdateOp;>;"
    .end local p2    # "badMove":I
    .end local p3    # "next":I
    .local v2, "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v7/widget/AdapterHelper$UpdateOp;>;"
    .local v3, "badMove":I
    .local v5, "next":I
    goto :goto_0

    .line 49
    .end local v2    # "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v7/widget/AdapterHelper$UpdateOp;>;"
    .end local v3    # "badMove":I
    .end local v5    # "next":I
    .restart local p1    # "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v7/widget/AdapterHelper$UpdateOp;>;"
    .restart local p2    # "badMove":I
    .restart local p3    # "next":I
    :pswitch_1
    move-object v1, p0
    ...
    .end local p2    # "badMove":I
    .end local p3    # "next":I
    .restart local v2    # "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v7/widget/AdapterHelper$UpdateOp;>;"
    .restart local v3    # "badMove":I
