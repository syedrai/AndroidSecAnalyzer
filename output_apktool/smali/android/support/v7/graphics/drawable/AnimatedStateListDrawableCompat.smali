...
.super Landroid/support/v7/graphics/drawable/StateListDrawableCompat;
...
.method constructor <init>(Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;Landroid/content/res/Resources;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat;-><init>(Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;->setConstantState(Landroid/support/v7/graphics/drawable/DrawableContainerCompat$DrawableContainerState;)V
...
.method public static createFromXmlInner(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;
    ...
    .line 177
    .local v2, "asl":Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;
    move-object v3, p0
    ...
    .line 173
    .end local v2    # "asl":Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;
...
.method private parseItem(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
    ...
    .line 559
    sget-object v0, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableItem:[I
    ...
    sget v1, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableItem_android_id:I
    ...
    sget v3, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableItem_android_drawable:I
    ...
    invoke-virtual {v4, p1, v3}, Landroid/support/v7/widget/ResourceManagerInternal;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 587
    invoke-static {p2, p3, p4, p5}, Landroid/support/v7/resources/Compatibility$Api21Impl;->createFromXmlInner(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private parseTransition(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)I
    ...
    .line 504
    sget-object v0, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableTransition:[I
    ...
    .line 506
    .local v0, "a":Landroid/content/res/TypedArray;
    sget v4, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableTransition_android_fromId:I
    ...
    .line 508
    .local v4, "fromId":I
    sget v6, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableTransition_android_toId:I
    ...
    sget v8, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableTransition_android_drawable:I
    ...
    invoke-virtual {v9, v10, v8}, Landroid/support/v7/widget/ResourceManagerInternal;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 516
    :goto_0
    sget v9, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableTransition_android_reversible:I
    ...
    invoke-virtual {v5, v4, v6, v7, v9}, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->addTransition(IILandroid/graphics/drawable/Drawable;Z)I
...
.method private selectTransition(I)Z
    ...
    .local v10, "transition":Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
    goto :goto_1

    .end local v10    # "transition":Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
    :cond_5
    ...
    invoke-direct {v6, v10}, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedVectorDrawableTransition;-><init>(Landroidx/vectordrawable/graphics/drawable/AnimatedVectorDrawableCompat;)V

    move-object v10, v6

    .restart local v10    # "transition":Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
    goto :goto_1
    ...
    .restart local v10    # "transition":Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
    :goto_1
    invoke-virtual {v10}, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$Transition;->start()V

    .line 343
    iput-object v10, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$Transition;
...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
    ...
    .line 449
    sget v1, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableCompat_android_variablePadding:I
    ...
    .line 452
    sget v1, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableCompat_android_constantSize:I
    ...
    .line 455
    sget v1, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableCompat_android_enterFadeDuration:I
    ...
    .line 458
    sget v1, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableCompat_android_exitFadeDuration:I
    ...
    .line 461
    sget v1, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableCompat_android_dither:I
...
.method clearMutated()V
    ...
    .line 615
    invoke-super {p0}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat;->clearMutated()V
...
.method bridge synthetic cloneConstantState()Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;
    .locals 1
...
.method public inflate(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 201
    sget-object v0, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableCompat:[I
    ...
    .line 203
    .local v0, "a":Landroid/content/res/TypedArray;
    sget v1, Landroid/support/v7/resources/R$styleable;->AnimatedStateListDrawableCompat_android_visible:I
...
.method public jumpToCurrentState()V
    ...
    .line 260
    invoke-super {p0}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat;->jumpToCurrentState()V
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    invoke-super {p0}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat;->mutate()Landroid/graphics/drawable/Drawable;
...
.method setConstantState(Landroid/support/v7/graphics/drawable/DrawableContainerCompat$DrawableContainerState;)V
    ...
    .line 712
    invoke-super {p0, p1}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat;->setConstantState(Landroid/support/v7/graphics/drawable/DrawableContainerCompat$DrawableContainerState;)V
...
.method public setVisible(ZZ)Z
    ...
    .line 214
    invoke-super {p0, p1, p2}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat;->setVisible(ZZ)Z
