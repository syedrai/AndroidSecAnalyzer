...
.super Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;
...
.method constructor <init>(Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat;Landroid/content/res/Resources;)V
    ...
    .line 630
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;-><init>(Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;Landroid/support/v7/graphics/drawable/StateListDrawableCompat;Landroid/content/res/Resources;)V

    .line 631
    if-eqz p1, :cond_0

    .line 633
    iget-object v0, p1, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Landroidx/collection/LongSparseArray;

    iput-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Landroidx/collection/LongSparseArray;

    .line 634
    iget-object v0, p1, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Landroidx/collection/SparseArrayCompat;

    iput-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Landroidx/collection/SparseArrayCompat;
...
.method addStateSet([ILandroid/graphics/drawable/Drawable;I)I
    ...
    .line 663
    invoke-super {p0, p1, p2}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;->addStateSet([ILandroid/graphics/drawable/Drawable;)I

    move-result v0

    .line 664
    .local v0, "index":I
    iget-object v1, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Landroidx/collection/SparseArrayCompat;
...
.method addTransition(IILandroid/graphics/drawable/Drawable;Z)I
    ...
    invoke-super {v0, v1}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;->addChild(Landroid/graphics/drawable/Drawable;)I
    ...
    .line 654
    :cond_0
    iget-object v7, v0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Landroidx/collection/LongSparseArray;
    ...
    iget-object v11, v0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Landroidx/collection/LongSparseArray;
...
.method indexOfKeyframe([I)I
    ...
    .line 669
    invoke-super {p0, p1}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;->indexOfStateSet([I)I
    ...
    invoke-super {p0, v1}, Landroid/support/v7/graphics/drawable/StateListDrawableCompat$StateListState;->indexOfStateSet([I)I
...
.method indexOfTransition(II)I
    ...
    iget-object v2, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Landroidx/collection/LongSparseArray;
...
.method mutate()V
    ...
    .line 643
    iget-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mTransitions:Landroidx/collection/LongSparseArray;
    ...
    .line 644
    iget-object v0, p0, Landroid/support/v7/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;->mStateIds:Landroidx/collection/SparseArrayCompat;
