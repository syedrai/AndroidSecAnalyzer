...
.method public createIntent(Landroid/content/Context;Landroidx/activity/result/PickVisualMediaRequest;)Landroid/content/Intent;
    ...
    .local v3, "$this$createIntent_u24lambda_u243":Landroid/content/Intent;
    const/4 v4, 0x0
    ...
    .line 1001
    invoke-virtual {v1}, Landroidx/activity/result/contract/ActivityResultContracts$PickVisualMedia$MediaCapabilities;->toApplicationMediaCapabilities$activity_release()Landroid/media/ApplicationMediaCapabilities;
    ...
    .line 999
    const-string v7, "android.provider.extra.MEDIA_CAPABILITIES"
    ...
    .line 978
    .end local v3    # "$this$createIntent_u24lambda_u243":Landroid/content/Intent;
    .end local v4    # "$i$a$-apply-ActivityResultContracts$PickMultipleVisualMedia$createIntent$1":I
    .end local v5    # "currentMaxItems":I
    goto/16 :goto_0

    .line 982
    .restart local v3    # "$this$createIntent_u24lambda_u243":Landroid/content/Intent;
    ...
    .local v4, "$this$createIntent_u24lambda_u245":Landroid/content/Intent;
    const/4 v5, 0x0
    ...
    .line 1008
    .end local v4    # "$this$createIntent_u24lambda_u245":Landroid/content/Intent;
    ...
    .restart local v4    # "$this$createIntent_u24lambda_u245":Landroid/content/Intent;
    ...
    .local v3, "$this$createIntent_u24lambda_u246":Landroid/content/Intent;
    const/4 v4, 0x0
    ...
    .line 1027
    .end local v3    # "$this$createIntent_u24lambda_u246":Landroid/content/Intent;
