...
.method private final startRearDisplayMode(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/window/area/WindowAreaSessionCallback;)V
    ...
    const-string v1, "rearDisplaySessionConsumer"
...
.method public presentContentOnWindowArea(Landroid/os/Binder;Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/window/area/WindowAreaPresentationSessionCallback;)V
    ...
    new-instance v2, Landroidx/window/area/WindowAreaControllerImpl$presentContentOnWindowArea$2;
    ...
    .end local p4    # "windowAreaPresentationSessionCallback":Landroidx/window/area/WindowAreaPresentationSessionCallback;
    .local v4, "activity":Landroid/app/Activity;
    .local v5, "executor":Ljava/util/concurrent/Executor;
    .local v6, "windowAreaPresentationSessionCallback":Landroidx/window/area/WindowAreaPresentationSessionCallback;
    ...
    .end local v6    # "windowAreaPresentationSessionCallback":Landroidx/window/area/WindowAreaPresentationSessionCallback;
    .local v0, "windowAreaPresentationSessionCallback":Landroidx/window/area/WindowAreaPresentationSessionCallback;
    ...
    .line 254
    .end local v0    # "windowAreaPresentationSessionCallback":Landroidx/window/area/WindowAreaPresentationSessionCallback;
    .restart local p2    # "activity":Landroid/app/Activity;
    .local p3, "executor":Ljava/util/concurrent/Executor;
    .local p4, "windowAreaPresentationSessionCallback":Landroidx/window/area/WindowAreaPresentationSessionCallback;
    :cond_1
    move-object v0, p4
    ...
    .line 255
    .end local p2    # "activity":Landroid/app/Activity;
    .restart local v0    # "windowAreaPresentationSessionCallback":Landroidx/window/area/WindowAreaPresentationSessionCallback;
    .local p3, "activity":Landroid/app/Activity;
    .local p4, "executor":Ljava/util/concurrent/Executor;
    nop
    ...
    .line 254
    invoke-direct {p0, p3, p4, v0}, Landroidx/window/area/WindowAreaControllerImpl;->startRearDisplayPresentationMode(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/window/area/WindowAreaPresentationSessionCallback;)V
...
.method public transferActivityToWindowArea(Landroid/os/Binder;Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/window/area/WindowAreaSessionCallback;)V
    ...
    new-instance v2, Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;
    ...
    .end local p2    # "activity":Landroid/app/Activity;
    .end local p3    # "executor":Ljava/util/concurrent/Executor;
    .end local p4    # "windowAreaSessionCallback":Landroidx/window/area/WindowAreaSessionCallback;
    .local v4, "activity":Landroid/app/Activity;
    .local v5, "executor":Ljava/util/concurrent/Executor;
    .local v6, "windowAreaSessionCallback":Landroidx/window/area/WindowAreaSessionCallback;
    ...
    .end local v4    # "activity":Landroid/app/Activity;
    .end local v5    # "executor":Ljava/util/concurrent/Executor;
    .end local v6    # "windowAreaSessionCallback":Landroidx/window/area/WindowAreaSessionCallback;
    .local v0, "windowAreaSessionCallback":Landroidx/window/area/WindowAreaSessionCallback;
    .local p3, "activity":Landroid/app/Activity;
    .local p4, "executor":Ljava/util/concurrent/Executor;
    move-object v4, v2
    ...
    .line 221
    .end local v0    # "windowAreaSessionCallback":Landroidx/window/area/WindowAreaSessionCallback;
    .restart local p2    # "activity":Landroid/app/Activity;
    .local p3, "executor":Ljava/util/concurrent/Executor;
    .local p4, "windowAreaSessionCallback":Landroidx/window/area/WindowAreaSessionCallback;
    :cond_1
    move-object v0, p4
    ...
    .end local p2    # "activity":Landroid/app/Activity;
    .restart local v0    # "windowAreaSessionCallback":Landroidx/window/area/WindowAreaSessionCallback;
    .local p3, "activity":Landroid/app/Activity;
    .local p4, "executor":Ljava/util/concurrent/Executor;
    invoke-direct {p0, p3, p4, v0}, Landroidx/window/area/WindowAreaControllerImpl;->startRearDisplayMode(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/window/area/WindowAreaSessionCallback;)V
