...
.method private scrollToPreferenceInternal(Landroidx/preference/Preference;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Landroidx/preference/PreferenceFragmentCompat;->mList:Landroid/support/v7/widget/RecyclerView;
...
.method private unbindPreferences()V
    ...
    .line 533
    invoke-virtual {p0}, Landroidx/preference/PreferenceFragmentCompat;->getListView()Landroid/support/v7/widget/RecyclerView;
...
.method bindPreferences()V
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/PreferenceFragmentCompat;->onCreateAdapter(Landroidx/preference/PreferenceScreen;)Landroid/support/v7/widget/RecyclerView$Adapter;
...
.method public final getListView()Landroid/support/v7/widget/RecyclerView;
    ...
    .line 555
    iget-object v0, p0, Landroidx/preference/PreferenceFragmentCompat;->mList:Landroid/support/v7/widget/RecyclerView;
...
.method public onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {p0}, Landroidx/preference/PreferenceFragmentCompat;->onCreateLayoutManager()Landroid/support/v7/widget/RecyclerView$LayoutManager;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p0, v6, v8, p3}, Landroidx/preference/PreferenceFragmentCompat;->onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/support/v7/widget/RecyclerView;
    ...
    .line 218
    iput-object v9, p0, Landroidx/preference/PreferenceFragmentCompat;->mList:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 229
    iget-object v3, p0, Landroidx/preference/PreferenceFragmentCompat;->mList:Landroid/support/v7/widget/RecyclerView;
...
.method public onDestroyView()V
    ...
    iput-object v0, p0, Landroidx/preference/PreferenceFragmentCompat;->mList:Landroid/support/v7/widget/RecyclerView;
...
.method public onDisplayPreferenceDialog(Landroidx/preference/Preference;)V
    ...
    .line 626
    .local v0, "handled":Z
    invoke-virtual {p0}, Landroidx/preference/PreferenceFragmentCompat;->getCallbackFragment()Landroid/support/v4/app/Fragment;
    ...
    .line 634
    .local v1, "callbackFragment":Landroid/support/v4/app/Fragment;
    :goto_0
    if-nez v0, :cond_2
    ...
    invoke-virtual {p0}, Landroidx/preference/PreferenceFragmentCompat;->getActivity()Landroid/support/v4/app/FragmentActivity;
    ...
    .line 657
    :cond_5
    invoke-virtual {p0}, Landroidx/preference/PreferenceFragmentCompat;->getParentFragmentManager()Landroid/support/v4/app/FragmentManager;
    ...
    .local v2, "f":Landroid/support/v4/app/DialogFragment;
    goto :goto_1

    .line 664
    .end local v2    # "f":Landroid/support/v4/app/DialogFragment;
    :cond_7
    ...
    .restart local v2    # "f":Landroid/support/v4/app/DialogFragment;
    goto :goto_1
    ...
    invoke-virtual {v2, p0, v4}, Landroid/support/v4/app/DialogFragment;->setTargetFragment(Landroid/support/v4/app/Fragment;I)V
    ...
    invoke-virtual {v2, v4, v3}, Landroid/support/v4/app/DialogFragment;->show(Landroid/support/v4/app/FragmentManager;Ljava/lang/String;)V
...
.method public onPreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    .line 420
    .local v2, "callbackFragment":Landroid/support/v4/app/Fragment;
    :goto_0
    if-nez v0, :cond_2
    ...
    invoke-virtual {v3}, Landroid/support/v4/app/FragmentManager;->getFragmentFactory()Landroid/support/v4/app/FragmentFactory;

    move-result-object v5

    .line 447
    invoke-virtual {p0}, Landroidx/preference/PreferenceFragmentCompat;->requireActivity()Landroid/support/v4/app/FragmentActivity;
    ...
    .line 446
    invoke-virtual {v5, v6, v7}, Landroid/support/v4/app/FragmentFactory;->instantiate(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    .line 449
    invoke-virtual {v5, p0, v1}, Landroid/support/v4/app/Fragment;->setTargetFragment(Landroid/support/v4/app/Fragment;I)V
    ...
    invoke-virtual {v1, v6, v5}, Landroid/support/v4/app/FragmentTransaction;->replace(ILandroid/support/v4/app/Fragment;)Landroid/support/v4/app/FragmentTransaction;
    ...
    .end local v2    # "callbackFragment":Landroid/support/v4/app/Fragment;
    :cond_6
    return v1
.end method
