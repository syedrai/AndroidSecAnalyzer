...
.method public createNotificationChannelGroup(Landroid/support/v4/app/NotificationChannelGroupCompat;)V
    .locals 1
    .param p1, "group"    # Landroid/support/v4/app/NotificationChannelGroupCompat;

    .line 477
    invoke-virtual {p1}, Landroid/support/v4/app/NotificationChannelGroupCompat;->getNotificationChannelGroup()Landroid/app/NotificationChannelGroup;
...
.method public createNotificationChannelGroupsCompat(Ljava/util/List;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
            "Landroid/support/v4/app/NotificationChannelGroupCompat;",
            ">;)V"
        }
    .end annotation

    .line 537
    .local p1, "groups":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/app/NotificationChannelGroupCompat;>;"
    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I
    ...
    check-cast v2, Landroid/support/v4/app/NotificationChannelGroupCompat;

    .line 540
    .local v2, "group":Landroid/support/v4/app/NotificationChannelGroupCompat;
    invoke-virtual {v2}, Landroid/support/v4/app/NotificationChannelGroupCompat;->getNotificationChannelGroup()Landroid/app/NotificationChannelGroup;
    ...
    .line 541
    .end local v2    # "group":Landroid/support/v4/app/NotificationChannelGroupCompat;
    goto :goto_0
...
.method public getNotificationChannelGroupCompat(Ljava/lang/String;)Landroid/support/v4/app/NotificationChannelGroupCompat;
    .locals 3
    .param p1, "channelGroupId"    # Ljava/lang/String;
    ...
    .line 694
    new-instance v1, Landroid/support/v4/app/NotificationChannelGroupCompat;

    invoke-direct {v1, v0}, Landroid/support/v4/app/NotificationChannelGroupCompat;-><init>(Landroid/app/NotificationChannelGroup;)V
    ...
    invoke-direct {v1, v0, v2}, Landroid/support/v4/app/NotificationChannelGroupCompat;-><init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
...
.method public getNotificationChannelGroupsCompat()Ljava/util/List;
    ...
    .line 760
    .local v3, "groupsCompat":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/app/NotificationChannelGroupCompat;>;"
    invoke-interface {v0}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .line 762
    new-instance v6, Landroid/support/v4/app/NotificationChannelGroupCompat;

    invoke-direct {v6, v5}, Landroid/support/v4/app/NotificationChannelGroupCompat;-><init>(Landroid/app/NotificationChannelGroup;)V
    ...
    invoke-direct {v6, v5, v1}, Landroid/support/v4/app/NotificationChannelGroupCompat;-><init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
    ...
    .end local v3    # "groupsCompat":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/app/NotificationChannelGroupCompat;>;"
    :cond_3
    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;
