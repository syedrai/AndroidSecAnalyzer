...
.method private getConnectedCondition()Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-static {v1, v2, v0}, Lcom/google/android/setupcompat/internal/SetupCompatServiceProvider$$ExternalSyntheticBackportWithForwarding0;->m(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private declared-synchronized requestServiceBind()V
    ...
    const-string v5, "Unable to bind to compat service. "
...
.method private waitForConnection(JLjava/util/concurrent/TimeUnit;)Lcom/google/android/setupcompat/ISetupCompatService;
    ...
    .line 109
    sget-object v5, Lcom/google/android/setupcompat/internal/SetupCompatServiceProvider;->LOG:Lcom/google/android/setupcompat/util/Logger;
    ...
    .line 110
    const-string v3, "Finished waiting for service to get connected. Current state = %s"
    ...
    .line 109
    invoke-virtual {v5, v3}, Lcom/google/android/setupcompat/util/Logger;->atInfo(Ljava/lang/String;)V
    ...
    const-string v3, "Failed to acquire connection after [%s %s]"
