...
.method private renderOnCanvas(Landroid/graphics/Canvas;F)V
    ...
    .line 188
    const v5, 0x43ba599a    # 372.7f

    invoke-virtual {v9, v5, v3}, Landroid/graphics/Path;->rLineTo(FF)V

    .line 189
    const/high16 v5, -0x3bfd0000    # -524.0f

    invoke-virtual {v9, v3, v5}, Landroid/graphics/Path;->rLineTo(FF)V
    ...
    invoke-virtual {v10, v5, v7}, Landroid/graphics/Path;->rLineTo(FF)V
    ...
    const v5, 0x43eb8ccd    # 471.1f

    invoke-virtual {v11, v5, v6}, Landroid/graphics/Path;->moveTo(FF)V

    .line 202
    const v5, 0x44302000    # 704.5f

    invoke-virtual {v11, v5, v3}, Landroid/graphics/Path;->rMoveTo(FF)V
    ...
    invoke-virtual {v12, v7, v6}, Landroid/graphics/Path;->moveTo(FF)V
    ...
    .line 217
    const v5, 0x439a599a    # 308.7f

    invoke-virtual {v13, v5, v6}, Landroid/graphics/Path;->lineTo(FF)V

    .line 218
    const v18, 0x440c8ccd    # 562.2f

    const/16 v19, 0x0

    const v14, 0x43bed99a    # 381.7f

    const v15, 0x44172666    # 604.6f

    const v16, 0x43f0cccd    # 481.6f

    const v17, 0x43ac2666    # 344.3f

    invoke-virtual/range {v13 .. v19}, Landroid/graphics/Path;->cubicTo(FFFFFF)V

    .line 219
    invoke-virtual {v13, v3, v3}, Landroid/graphics/Path;->lineTo(FF)V
    ...
    .line 223
    .end local v13    # "p":Landroid/graphics/Path;
    ...
    .line 224
    invoke-virtual {v14, v3, v3}, Landroid/graphics/Path;->lineTo(FF)V
    ...
    const v15, 0x43a3d99a    # 327.7f

    const v16, 0x43eda666    # 475.3f

    const v17, 0x43648000    # 228.5f

    const/high16 v18, 0x43490000    # 201.0f
...
.method public scaleCanvasToBounds(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v6, v5, v8, v4}, Landroid/graphics/Canvas;->scale(FFFF)V
    ...
    invoke-virtual {p1, v5, v6, v4, v8}, Landroid/graphics/Canvas;->scale(FFFF)V
