...
.method private finalizeReference(Ljava/lang/ref/Reference;Ljava/lang/reflect/Method;)Z
    ...
    const-string v4, "finalizeReference"
...
.method public static startFinalizer(Ljava/lang/Class;Ljava/lang/ref/ReferenceQueue;Ljava/lang/ref/PhantomReference;)V
    ...
    .line 79
    .local v1, "finalizer":Lcom/google/common/base/internal/Finalizer;
    const-class v0, Lcom/google/common/base/internal/Finalizer;
    ...
    .line 84
    .local v0, "inheritThreadLocals":Z
    ...
    .line 91
    .end local v0    # "inheritThreadLocals":Z
    ...
    const-string v9, "startFinalizer"

    const-string v10, "Failed to create a thread without inherited thread-local values"

    const-string v8, "com.google.common.base.internal.Finalizer"
    ...
    const-string v8, "Failed to clear thread local values inherited by reference finalizer thread."
    ...
    .line 75
    .end local v1    # "finalizer":Lcom/google/common/base/internal/Finalizer;
