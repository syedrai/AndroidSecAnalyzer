...
.method constructor <init>(Lj$/util/concurrent/ConcurrentHashMap$BulkTask;III[Lj$/util/concurrent/ConcurrentHashMap$Node;Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;Ljava/util/function/BiFunction;Ljava/util/function/BiFunction;)V
    ...
    .local p4, "i":I
    .local p5, "f":I
    iput-object p6, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->nextRight:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;

    .line 5708
    iput-object p7, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->transformer:Ljava/util/function/BiFunction;

    .line 5709
    iput-object p8, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->reducer:Ljava/util/function/BiFunction;
...
.method public final compute()V
    ...
    iput-object v1, v2, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;
    ...
    invoke-interface {v8, v1, v4}, Ljava/util/function/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_4
    iput-object v0, v2, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->result:Ljava/lang/Object;
    ...
    check-cast v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;

    .line 5736
    .local v3, "t":Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask<TK;TV;TU;>;"
    iget-object v4, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;

    .line 5737
    .local v4, "s":Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask<TK;TV;TU;>;"
    :goto_5
    if-eqz v4, :cond_7

    .line 5739
    iget-object v5, v4, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->result:Ljava/lang/Object;
    ...
    .line 5740
    iget-object v5, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->result:Ljava/lang/Object;
    ...
    :goto_6
    iput-object v5, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->result:Ljava/lang/Object;

    .line 5742
    .end local v7    # "tr":Ljava/lang/Object;, "TU;"
    :cond_6
    iget-object v5, v4, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->nextRight:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;

    iput-object v5, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;
    ...
    .line 5732
    .end local v3    # "t":Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask<TK;TV;TU;>;"
    .end local v4    # "s":Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceMappingsTask<TK;TV;TU;>;"
    :cond_7
