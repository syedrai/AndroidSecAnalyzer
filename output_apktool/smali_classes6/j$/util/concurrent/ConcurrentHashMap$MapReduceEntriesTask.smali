...
.method constructor <init>(Lj$/util/concurrent/ConcurrentHashMap$BulkTask;III[Lj$/util/concurrent/ConcurrentHashMap$Node;Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;Ljava/util/function/Function;Ljava/util/function/BiFunction;)V
    ...
    .local p4, "i":I
    .local p5, "f":I
    iput-object p6, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->nextRight:Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;

    .line 5654
    iput-object p7, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->transformer:Ljava/util/function/Function;

    .line 5655
    iput-object p8, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->reducer:Ljava/util/function/BiFunction;
...
.method public final compute()V
    ...
    iput-object v1, v2, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;
    ...
    :cond_4
    iput-object v0, v2, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->result:Ljava/lang/Object;
    ...
    check-cast v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;

    .line 5682
    .local v3, "t":Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask<TK;TV;TU;>;"
    iget-object v4, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;

    .line 5683
    .local v4, "s":Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask<TK;TV;TU;>;"
    :goto_5
    if-eqz v4, :cond_7

    .line 5685
    iget-object v5, v4, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->result:Ljava/lang/Object;
    ...
    .line 5686
    iget-object v5, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->result:Ljava/lang/Object;
    ...
    :goto_6
    iput-object v5, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->result:Ljava/lang/Object;

    .line 5688
    .end local v7    # "tr":Ljava/lang/Object;, "TU;"
    :cond_6
    iget-object v5, v4, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->nextRight:Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;

    iput-object v5, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;
    ...
    .line 5678
    .end local v3    # "t":Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask<TK;TV;TU;>;"
    .end local v4    # "s":Lj$/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceEntriesTask<TK;TV;TU;>;"
    :cond_7
