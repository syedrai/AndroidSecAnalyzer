...
.method constructor <init>(Lj$/util/concurrent/ConcurrentHashMap$BulkTask;III[Lj$/util/concurrent/ConcurrentHashMap$Node;Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;Ljava/util/function/ToLongBiFunction;JLjava/util/function/LongBinaryOperator;)V
    ...
    .local p4, "i":I
    .local p5, "f":I
    iput-object p6, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->nextRight:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;

    .line 6114
    iput-object p7, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->transformer:Ljava/util/function/ToLongBiFunction;

    .line 6115
    iput-wide p8, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->basis:J

    iput-object p10, p1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->reducer:Ljava/util/function/LongBinaryOperator;
...
.method public final compute()V
    ...
    .line 6121
    .local p0, "this":Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask<TK;TV;>;"
    iget-object v0, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->transformer:Ljava/util/function/ToLongBiFunction;

    move-object v8, v0

    .local v8, "transformer":Ljava/util/function/ToLongBiFunction;, "Ljava/util/function/ToLongBiFunction<-TK;-TV;>;"
    if-eqz v0, :cond_5

    iget-object v11, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->reducer:Ljava/util/function/LongBinaryOperator;
    ...
    .line 6123
    iget-wide v9, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->basis:J

    .line 6124
    .local v9, "r":J
    iget v0, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->baseIndex:I

    .local v0, "i":I
    :goto_0
    iget v1, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->batch:I

    if-lez v1, :cond_1

    iget v5, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->baseLimit:I
    ...
    .line 6126
    invoke-virtual {p0, v2}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->addToPendingCount(I)V

    .line 6127
    new-instance v1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;

    iget v3, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->batch:I

    ushr-int/2addr v3, v2

    iput v3, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->batch:I

    iput v4, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->baseLimit:I

    iget-object v6, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->tab:[Lj$/util/concurrent/ConcurrentHashMap$Node;

    iget-object v7, p0, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;

    move-object v2, p0

    invoke-direct/range {v1 .. v11}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;-><init>(Lj$/util/concurrent/ConcurrentHashMap$BulkTask;III[Lj$/util/concurrent/ConcurrentHashMap$Node;Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;Ljava/util/function/ToLongBiFunction;JLjava/util/function/LongBinaryOperator;)V

    iput-object v1, v2, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;

    .line 6129
    invoke-virtual {v1}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->fork()Ljava/util/concurrent/ForkJoinTask;
    ...
    .end local v0    # "i":I
    :goto_1
    invoke-virtual {p0}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->advance()Lj$/util/concurrent/ConcurrentHashMap$Node;
    ...
    invoke-interface {v8, v0, v3}, Ljava/util/function/ToLongBiFunction;->applyAsLong(Ljava/lang/Object;Ljava/lang/Object;)J
    ...
    :cond_2
    iput-wide v9, v2, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->result:J

    .line 6135
    invoke-virtual {p0}, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->firstComplete()Ljava/util/concurrent/CountedCompleter;
    ...
    iget-object v3, v1, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->rights:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;

    .line 6140
    .local v3, "s":Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask<TK;TV;>;"
    :goto_3
    if-eqz v3, :cond_3
    ...
    iget-wide v6, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->result:J
    ...
    .line 6142
    iget-object v4, v3, Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;->nextRight:Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;
    ...
    .end local v3    # "s":Lj$/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask;, "Ljava/util/concurrent/ConcurrentHashMap$MapReduceMappingsToLongTask<TK;TV;>;"
    :cond_3
