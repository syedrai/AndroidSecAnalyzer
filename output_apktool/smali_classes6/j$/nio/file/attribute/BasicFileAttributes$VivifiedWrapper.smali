.class public final synthetic Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;
...
# instance fields
.field public final synthetic wrappedValue:Ljava/nio/file/attribute/BasicFileAttributes;
...
.method private synthetic constructor <init>(Ljava/nio/file/attribute/BasicFileAttributes;)V
    ...
    iput-object p1, p0, Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;->wrappedValue:Ljava/nio/file/attribute/BasicFileAttributes;

    return-void
.end method

.method public static synthetic convert(Ljava/nio/file/attribute/BasicFileAttributes;)Lj$/nio/file/attribute/BasicFileAttributes;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Lj$/nio/file/attribute/BasicFileAttributes$Wrapper;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/nio/file/attribute/BasicFileAttributes$Wrapper;

    iget-object p0, p0, Lj$/nio/file/attribute/BasicFileAttributes$Wrapper;->wrappedValue:Lj$/nio/file/attribute/BasicFileAttributes;
    ...
    invoke-static {p0}, Lj$/nio/file/attribute/DosFileAttributes$VivifiedWrapper;->convert(Ljava/nio/file/attribute/DosFileAttributes;)Lj$/nio/file/attribute/DosFileAttributes;
    ...
    invoke-static {p0}, Lj$/nio/file/attribute/PosixFileAttributes$VivifiedWrapper;->convert(Ljava/nio/file/attribute/PosixFileAttributes;)Lj$/nio/file/attribute/PosixFileAttributes;
    ...
    :cond_3
    new-instance v0, Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;

    invoke-direct {v0, p0}, Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;-><init>(Ljava/nio/file/attribute/BasicFileAttributes;)V
...
.method public synthetic creationTime()Lj$/nio/file/attribute/FileTime;
    ...
    iget-object v0, p0, Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;->wrappedValue:Ljava/nio/file/attribute/BasicFileAttributes;
...
.method public synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;

    if-eqz v1, :cond_0

    check-cast p1, Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;

    iget-object p1, p1, Lj$/nio/file/attribute/BasicFileAttributes$VivifiedWrapper;->wrappedValue:Ljava/nio/file/attribute/BasicFileAttributes;
