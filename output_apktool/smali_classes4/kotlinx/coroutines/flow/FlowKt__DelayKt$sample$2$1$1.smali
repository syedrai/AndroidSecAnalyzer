...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 281
    .local v4, "$i$a$-onSuccess-WpGqRn0-FlowKt__DelayKt$sample$2$1$1$1":I
    iput-object v3, v1, Lkotlin/jvm/internal/Ref$ObjectRef;->element:Ljava/lang/Object;

    .line 408
    .end local v3    # "it":Ljava/lang/Object;
    .end local v4    # "$i$a$-onSuccess-WpGqRn0-FlowKt__DelayKt$sample$2$1$1$1":I
    :cond_0
    nop
    ...
    .line 410
    .local v3, "$i$f$onFailure-WpGqRn0":I
    instance-of v4, v0, Lkotlinx/coroutines/channels/ChannelResult$Failed;
    ...
    .line 283
    .local v5, "$i$a$-onFailure-WpGqRn0-FlowKt__DelayKt$sample$2$1$1$2":I
    if-nez v4, :cond_1
    ...
    invoke-interface {v1, v6}, Lkotlinx/coroutines/channels/ReceiveChannel;->cancel(Ljava/util/concurrent/CancellationException;)V
    ...
    .line 283
    .local v1, "$i$a$-let-FlowKt__DelayKt$sample$2$1$1$2$1":I
    throw v0

    .line 410
    .end local v1    # "$i$a$-let-FlowKt__DelayKt$sample$2$1$1$2$1":I
    .end local v4    # "it":Ljava/lang/Throwable;
    .end local v5    # "$i$a$-onFailure-WpGqRn0-FlowKt__DelayKt$sample$2$1$1$2":I
    .local v0, "$this$onFailure_u2dWpGqRn0$iv":Ljava/lang/Object;
    :cond_2
    :goto_0
    nop
    ...
    .line 287
    .end local v0    # "$this$onFailure_u2dWpGqRn0$iv":Ljava/lang/Object;
    .end local v3    # "$i$f$onFailure-WpGqRn0":I
