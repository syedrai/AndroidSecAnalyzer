...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "()Ljava/lang/String;",
        "Lokio/ByteString;",
        "getBytes$third_party_java_src_okio_okio_jvm",
        "()Lokio/ByteString;",
        "getRoot",
        "root",
        "",
...
.method public static final get(Lj$/nio/file/Path;)Lokio/Path;
    .locals 1
    .param p0, "$this$get"    # Lj$/nio/file/Path;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
    ...
    invoke-virtual {v0, p0}, Lokio/Path$Companion;->get(Lj$/nio/file/Path;)Lokio/Path;
...
.method public static final get(Lj$/nio/file/Path;Z)Lokio/Path;
    .locals 1
    .param p0, "$this$get"    # Lj$/nio/file/Path;
    ...
    invoke-virtual {v0, p0, p1}, Lokio/Path$Companion;->get(Lj$/nio/file/Path;Z)Lokio/Path;
...
.method public static final get(Ljava/io/File;)Lokio/Path;
    .locals 1
    .param p0, "$this$get"    # Ljava/io/File;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
...
.method public compareTo(Lokio/Path;)I
    ...
    invoke-virtual {v0}, Lokio/Path;->getBytes$third_party_java_src_okio_okio_jvm()Lokio/ByteString;

    move-result-object v2

    invoke-virtual {p1}, Lokio/Path;->getBytes$third_party_java_src_okio_okio_jvm()Lokio/ByteString;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v2}, Lokio/Path;->getBytes$third_party_java_src_okio_okio_jvm()Lokio/ByteString;
...
.method public final getBytes$third_party_java_src_okio_okio_jvm()Lokio/ByteString;
    .locals 1
