...
.method public constructor <init>(Ljava/io/Writer;)V
    ...
    iput v1, p0, Lorg/bouncycastle/util/io/pem/PemWriter;->nlLength:I
...
.method private writeEncoded([B)V
    ...
    invoke-virtual {p0, v2, v3, v1}, Lorg/bouncycastle/util/io/pem/PemWriter;->write([CII)V
...
.method public getOutputSize(Lorg/bouncycastle/util/io/pem/PemObject;)I
    ...
    .line 60
    .local v2, "hdr":Lorg/bouncycastle/util/io/pem/PemHeader;
    ...
    .line 61
    .end local v2    # "hdr":Lorg/bouncycastle/util/io/pem/PemHeader;
    goto :goto_0
...
.method public writeObject(Lorg/bouncycastle/util/io/pem/PemObjectGenerator;)V
    .locals 4
    .param p1, "objGen"    # Lorg/bouncycastle/util/io/pem/PemObjectGenerator;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/util/io/pem/PemWriter;->writePreEncapsulationBoundary(Ljava/lang/String;)V

    .line 81
    invoke-virtual {v0}, Lorg/bouncycastle/util/io/pem/PemObject;->getHeaders()Ljava/util/List;
    ...
    .line 96
    :cond_1
    invoke-virtual {v0}, Lorg/bouncycastle/util/io/pem/PemObject;->getContent()[B

    move-result-object v1

    invoke-direct {p0, v1}, Lorg/bouncycastle/util/io/pem/PemWriter;->writeEncoded([B)V
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/util/io/pem/PemWriter;->writePostEncapsulationBoundary(Ljava/lang/String;)V
