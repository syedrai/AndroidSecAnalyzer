...
.method private generateJcaObject(Lorg/bouncycastle/asn1/x509/TBSCertList;[B)Ljava/security/cert/X509CRL;
    .locals 3
    .param p1, "tbsCrl"    # Lorg/bouncycastle/asn1/x509/TBSCertList;
...
.method public addCRL(Ljava/security/cert/X509CRL;)V
    ...
    .line 149
    .local v0, "revocations":Ljava/util/Set;
    if-eqz v0, :cond_0
    ...
    :try_start_0
    iget-object v4, p0, Lorg/bouncycastle/x509/X509V2CRLGenerator;->tbsGen:Lorg/bouncycastle/asn1/x509/V2TBSCertListGenerator;
    ...
    invoke-virtual {v4, v5}, Lorg/bouncycastle/asn1/x509/V2TBSCertListGenerator;->addCRLEntry(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    :try_end_0
    ...
    .line 162
    .restart local v2    # "entry":Ljava/security/cert/X509CRLEntry;
    ...
    const-string v8, "exception processing encoding of CRL: "
...
.method public addCRLEntry(Ljava/math/BigInteger;Ljava/util/Date;Lorg/bouncycastle/asn1/x509/X509Extensions;)V
    ...
    .param p1, "userCertificate"    # Ljava/math/BigInteger;
    .param p2, "revocationDate"    # Ljava/util/Date;
    .param p3, "extensions"    # Lorg/bouncycastle/asn1/x509/X509Extensions;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
            0x0,
...
.method public generate(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)Ljava/security/cert/X509CRL;
    ...
    new-instance v2, Lorg/bouncycastle/x509/X509V2CRLGenerator$ExtCRLException;

    const-string v3, "cannot generate CRL encoding"

    invoke-direct {v2, v3, v1}, Lorg/bouncycastle/x509/X509V2CRLGenerator$ExtCRLException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
