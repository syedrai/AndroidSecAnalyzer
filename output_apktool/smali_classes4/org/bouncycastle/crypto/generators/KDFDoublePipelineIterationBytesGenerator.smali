...
.method public constructor <init>(Lorg/bouncycastle/crypto/Mac;)V
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->h:I
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->k:[B
...
.method private generateNext()V
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->fixedInputData:[B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->a:[B
    ...
    .line 158
    .local v0, "i":I
    iget-object v2, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->ios:[B
    ...
    .line 175
    iget-object v2, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->prf:Lorg/bouncycastle/crypto/Mac;

    iget-object v3, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->ios:[B

    iget-object v4, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->ios:[B
...
.method public generateBytes([BII)I
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->maxSizeExcl:I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->h:I
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->generatedBytes:I

    iget v5, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->h:I
    ...
    .line 116
    .local v4, "toCopy":I
    iget-object v5, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->k:[B

    invoke-static {v5, v2, p1, p2, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 117
    iget v5, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->generatedBytes:I

    add-int/2addr v5, v4

    iput v5, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->generatedBytes:I
...
.method public init(Lorg/bouncycastle/crypto/DerivationParameters;)V
    ...
    check-cast v0, Lorg/bouncycastle/crypto/params/KDFDoublePipelineIterationParameters;

    .line 62
    .local v0, "dpiParams":Lorg/bouncycastle/crypto/params/KDFDoublePipelineIterationParameters;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/KDFDoublePipelineIterationParameters;->getKI()[B
    ...
    .line 66
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/KDFDoublePipelineIterationParameters;->getFixedInputData()[B

    move-result-object v1

    iput-object v1, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->fixedInputData:[B

    .line 68
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/KDFDoublePipelineIterationParameters;->getR()I
    ...
    iput-object v2, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->ios:[B

    .line 71
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/KDFDoublePipelineIterationParameters;->useCounter()Z
    ...
    .line 74
    sget-object v2, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->TWO:Ljava/math/BigInteger;

    invoke-virtual {v2, v1}, Ljava/math/BigInteger;->pow(I)Ljava/math/BigInteger;

    move-result-object v2

    iget v4, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->h:I
    ...
    sget-object v4, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->INTEGER_MAX:Ljava/math/BigInteger;
    ...
    :goto_0
    iput v3, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->maxSizeExcl:I
    ...
    iput-boolean v2, p0, Lorg/bouncycastle/crypto/generators/KDFDoublePipelineIterationBytesGenerator;->useCounter:Z
    ...
    .line 55
    .end local v0    # "dpiParams":Lorg/bouncycastle/crypto/params/KDFDoublePipelineIterationParameters;
    .end local v1    # "r":I
    :cond_2
