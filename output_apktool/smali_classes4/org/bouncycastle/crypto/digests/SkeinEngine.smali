...
.method public constructor <init>(II)V
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->outputSizeBytes:I

    .line 521
    new-instance v0, Lorg/bouncycastle/crypto/engines/ThreefishEngine;

    invoke-direct {v0, p1}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;-><init>(I)V

    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->threefish:Lorg/bouncycastle/crypto/engines/ThreefishEngine;

    .line 522
    new-instance v0, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->getBlockSize()I

    move-result v1

    invoke-direct {v0, p0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;-><init>(Lorg/bouncycastle/crypto/digests/SkeinEngine;I)V

    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubi:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/digests/SkeinEngine;)V
    .locals 2
    .param p1, "engine"    # Lorg/bouncycastle/crypto/digests/SkeinEngine;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
...
.method private static clone([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    .locals 2
    .param p0, "data"    # [Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    .param p1, "existing"    # [Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
            0x0
    ...
    new-array p1, v0, [Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
...
.method private copyIn(Lorg/bouncycastle/crypto/digests/SkeinEngine;)V
    ...
    .line 541
    iget-object v0, p1, Lorg/bouncycastle/crypto/digests/SkeinEngine;->postMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->postMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
...
.method private createInitialState()V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->chain:[J
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->key:[B

    invoke-direct {p0, v1, v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubiComplete(I[B)V
    ...
    invoke-direct {v1, v2, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Configuration;-><init>(J)V
    ...
    invoke-direct {p0, v2, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubiComplete(I[B)V
    ...
    .local v1, "i":I
    :goto_1
    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->preMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    .line 696
    .local v2, "param":Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    invoke-direct {p0, v3, v4}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubiComplete(I[B)V

    .line 693
    .end local v2    # "param":Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initialState:[J
...
.method private initParams(Ljava/util/Hashtable;)V
    ...
    .line 615
    .local v1, "pre":Ljava/util/Vector;
    new-instance v2, Ljava/util/Vector;

    invoke-direct {v2}, Ljava/util/Vector;-><init>()V

    .line 617
    .local v2, "post":Ljava/util/Vector;
    :goto_0
    ...
    invoke-direct {v5, v6, v4}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;-><init>(I[B)V
    ...
    new-array v3, v3, [Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

    iput-object v3, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->preMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

    .line 636
    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->preMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    invoke-static {v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->sort([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)V
    ...
    iput-object v3, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->postMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

    .line 640
    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->postMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
...
.method private output(J[BII)V
    ...
    .line 788
    .local v1, "currentBytes":[B
    const/4 v2, 0x0

    invoke-static {p1, p2, v1, v2}, Lorg/bouncycastle/util/Pack;->longToLittleEndian(J[BI)V

    .line 792
    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->chain:[J
    ...
    .line 793
    .local v3, "outputWords":[J
    const/16 v4, 0x3f

    invoke-direct {p0, v4}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubiInit(I)V

    .line 794
    iget-object v4, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubi:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;

    array-length v5, v1

    invoke-virtual {v4, v1, v2, v5, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->update([BII[J)V

    .line 795
    iget-object v4, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubi:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;

    invoke-virtual {v4, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->doFinal([J)V
    ...
    invoke-static {v7, v8, p3, v9}, Lorg/bouncycastle/util/Pack;->longToLittleEndian(J[BI)V
...
.method private static sort([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)V
    .locals 5
    .param p0, "params"    # [Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
    ...
    .line 654
    .local v1, "param":Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    move v2, v0
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->getType()I
    ...
    .line 651
    .end local v1    # "param":Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    .end local v2    # "hole":I
...
.method private ubiComplete(I[B)V
    ...
    invoke-virtual {v0, p2, v3, v1, v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->update([BII[J)V
...
.method public doFinal([BI)I
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->getValue()[B

    move-result-object v3

    invoke-direct {p0, v2, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubiComplete(I[B)V
    ...
    .end local p1    # "out":[B
    .local v7, "out":[B
    invoke-direct/range {v4 .. v9}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->output(J[BII)V

    .line 774
    .end local v9    # "toWrite":I
    add-int/lit8 v2, v2, 0x1
    ...
    .line 782
    iget p1, v4, Lorg/bouncycastle/crypto/digests/SkeinEngine;->outputSizeBytes:I

    return p1

    .line 755
    .end local v0    # "blockSize":I
    .end local v1    # "blocksRequired":I
    .end local v7    # "out":[B
    .restart local p1    # "out":[B
    :cond_2
    move-object v7, p1
    ...
    const-string v0, "Output buffer is too short to hold output"
...
.method public init(Lorg/bouncycastle/crypto/params/SkeinParameters;)V
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initParams(Ljava/util/Hashtable;)V
...
.method public reset(Lorg/bouncycastle/util/Memoable;)V
    ...
    check-cast v0, Lorg/bouncycastle/crypto/digests/SkeinEngine;

    .line 566
    .local v0, "s":Lorg/bouncycastle/crypto/digests/SkeinEngine;
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->getBlockSize()I
    ...
    iget v2, v0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->outputSizeBytes:I

    if-ne v1, v2, :cond_0

    .line 570
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->copyIn(Lorg/bouncycastle/crypto/digests/SkeinEngine;)V
...
.method public update(B)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->update([BII)V
