...
.method constructor <init>(Ljavax/crypto/spec/DHPrivateKeySpec;)V
    ...
    check-cast v0, Lorg/bouncycastle/jcajce/spec/DHExtendedPrivateKeySpec;

    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/spec/DHExtendedPrivateKeySpec;->getParams()Ljavax/crypto/spec/DHParameterSpec;
...
.method public constructor <init>(Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;)V
    ...
    iput-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->x:Ljava/math/BigInteger;
    ...
    iput-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->dhSpec:Ljavax/crypto/spec/DHParameterSpec;

    .line 90
    new-instance v4, Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;
    ...
    invoke-direct {v6, v7, v8, v10, v9}, Lorg/bouncycastle/crypto/params/DHParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v4, v5, v6}, Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/DHParameters;)V

    iput-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->dhPrivateKey:Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;
    ...
    new-instance v4, Lorg/bouncycastle/jcajce/spec/DHDomainParameterSpec;

    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x9/DomainParameters;->getP()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x9/DomainParameters;->getQ()Ljava/math/BigInteger;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x9/DomainParameters;->getJ()Ljava/math/BigInteger;

    move-result-object v8

    const/4 v9, 0x0

    invoke-direct/range {v4 .. v9}, Lorg/bouncycastle/jcajce/spec/DHDomainParameterSpec;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V
...
.method constructor <init>(Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;)V
    .locals 2
    .param p1, "params"    # Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
...
.method public getEncoded()[B
    ...
    .line 158
    .local v2, "validationParameters":Lorg/bouncycastle/crypto/params/DHValidationParameters;
    const/4 v3, 0x0

    .line 159
    .local v3, "vParams":Lorg/bouncycastle/asn1/x9/ValidationParams;
    if-eqz v2, :cond_1

    .line 161
    new-instance v4, Lorg/bouncycastle/asn1/x9/ValidationParams;

    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/DHValidationParameters;->getSeed()[B

    move-result-object v5

    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/DHValidationParameters;->getCounter()I

    move-result v6

    invoke-direct {v4, v5, v6}, Lorg/bouncycastle/asn1/x9/ValidationParams;-><init>([BI)V
    ...
    .line 163
    .end local v3    # "vParams":Lorg/bouncycastle/asn1/x9/ValidationParams;
    ...
    invoke-direct {v10, v11, v3}, Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;-><init>(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Lorg/bouncycastle/asn1/ASN1Encodable;)V
    ...
    invoke-direct {v9, v10, v3}, Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;-><init>(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Lorg/bouncycastle/asn1/ASN1Encodable;)V

    .line 164
    .end local v0    # "params":Lorg/bouncycastle/crypto/params/DHParameters;
    .end local v2    # "validationParameters":Lorg/bouncycastle/crypto/params/DHValidationParameters;
    .end local v8    # "vParams":Lorg/bouncycastle/asn1/x9/ValidationParams;
    .local v9, "info":Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;
    goto :goto_1

    .line 167
    .end local v9    # "info":Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;
    :cond_2
    ...
    .line 169
    .restart local v9    # "info":Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;
    :goto_1
    invoke-virtual {v9, v1}, Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;->getEncoded(Ljava/lang/String;)[B
