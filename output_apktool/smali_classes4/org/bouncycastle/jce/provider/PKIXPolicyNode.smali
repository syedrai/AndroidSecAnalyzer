...
.method public addChild(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .locals 1
    .param p1, "_child"    # Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
...
.method public copy()Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    iget v3, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->depth:I

    new-instance v7, Ljava/lang/String;

    iget-object v5, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->validPolicy:Ljava/lang/String;

    invoke-direct {v7, v5}, Ljava/lang/String;-><init>(Ljava/lang/String;)V

    iget-boolean v8, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->critical:Z
    ...
    .line 158
    .local v1, "_node":Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    .line 162
    .local v2, "_child":Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    invoke-virtual {v2, v1}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->setParent(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V

    .line 163
    invoke-virtual {v1, v2}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->addChild(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V

    .line 164
    .end local v2    # "_child":Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    goto :goto_2
...
.method public setParent(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .locals 0
    .param p1, "_parent"    # Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
