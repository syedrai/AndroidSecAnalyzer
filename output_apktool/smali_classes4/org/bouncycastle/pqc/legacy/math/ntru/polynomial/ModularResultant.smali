...
.method static combineRho(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;)Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;
    .locals 8
    .param p0, "modRes1"    # Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;
    .param p1, "modRes2"    # Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
            0x0
    ...
    .line 37
    .local v3, "er":Lorg/bouncycastle/pqc/legacy/math/ntru/euclid/BigIntEuclidean;
    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;->rho:Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;
    ...
    .line 38
    .local v4, "rho1":Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;
    iget-object v5, v3, Lorg/bouncycastle/pqc/legacy/math/ntru/euclid/BigIntEuclidean;->x:Ljava/math/BigInteger;

    invoke-virtual {v5, v1}, Ljava/math/BigInteger;->multiply(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v4, v5}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;->mult(Ljava/math/BigInteger;)V

    .line 39
    iget-object v5, p1, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;->rho:Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;

    invoke-virtual {v5}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;->clone()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;

    .line 40
    .local v5, "rho2":Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;
    iget-object v6, v3, Lorg/bouncycastle/pqc/legacy/math/ntru/euclid/BigIntEuclidean;->y:Ljava/math/BigInteger;

    invoke-virtual {v6, v0}, Ljava/math/BigInteger;->multiply(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v6

    invoke-virtual {v5, v6}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;->mult(Ljava/math/BigInteger;)V

    .line 41
    invoke-virtual {v4, v5}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;->add(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;)V

    .line 42
    invoke-virtual {v4, v2}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;->mod(Ljava/math/BigInteger;)V

    .line 44
    new-instance v6, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;

    const/4 v7, 0x0

    invoke-direct {v6, v4, v7, v2}, Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/ModularResultant;-><init>(Lorg/bouncycastle/pqc/legacy/math/ntru/polynomial/BigIntPolynomial;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
