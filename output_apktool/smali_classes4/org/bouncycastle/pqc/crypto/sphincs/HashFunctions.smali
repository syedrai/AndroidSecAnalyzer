...
.method constructor <init>(Lorg/bouncycastle/crypto/Digest;)V
    .locals 1
    .param p1, "dig256"    # Lorg/bouncycastle/crypto/Digest;
...
.method constructor <init>(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/crypto/Digest;)V
    .locals 1
    .param p1, "dig256"    # Lorg/bouncycastle/crypto/Digest;
    .param p2, "dig512"    # Lorg/bouncycastle/crypto/Digest;
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
            0x0
...
.method hash_2n_n([BI[BI)I
    ...
    sget-object v3, Lorg/bouncycastle/pqc/crypto/sphincs/HashFunctions;->hashc:[B
    ...
    .line 51
    :cond_0
    iget-object v3, p0, Lorg/bouncycastle/pqc/crypto/sphincs/HashFunctions;->perm:Lorg/bouncycastle/pqc/crypto/sphincs/Permute;

    invoke-virtual {v3, v0, v0}, Lorg/bouncycastle/pqc/crypto/sphincs/Permute;->chacha_permute([B[B)V
...
.method hash_2n_n_mask([BI[BI[BI)I
    ...
    invoke-virtual {p0, p1, p2, v1, v0}, Lorg/bouncycastle/pqc/crypto/sphincs/HashFunctions;->hash_2n_n([BI[BI)I
...
.method hash_n_n_mask([BI[BI[BI)I
    ...
    invoke-virtual {p0, p1, p2, v1, v0}, Lorg/bouncycastle/pqc/crypto/sphincs/HashFunctions;->hash_n_n([BI[BI)I
